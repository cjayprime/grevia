  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-bg-features">
        <span className="auth-bg-feature" style={{ top: "12%", left: "8%" }}>
          Double Materiality Studio
        </span>
        <span className="auth-bg-feature" style={{ top: "22%", right: "6%" }}>
          ESRS Compliance
        </span>
        <span className="auth-bg-feature" style={{ top: "42%", left: "4%" }}>
          Scope 1-3 Emissions
        </span>
        <span
          className="auth-bg-feature"
        ...
        <span className="auth-bg-feature" style={{ top: "8%", left: "42%" }}>
          Multi-Agent AI
        </span>
        <span
          className="auth-bg-feature"
        ...
        <span className="auth-bg-feature" style={{ top: "55%", right: "3%" }}>
          CSRD Reporting
        </span>
        <span className="auth-bg-feature" style={{ bottom: "42%", left: "2%" }}>
          Hot Store
        </span>
        <span className="auth-bg-feature" style={{ top: "68%", left: "18%" }}>
